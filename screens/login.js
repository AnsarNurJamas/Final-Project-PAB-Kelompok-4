...
import { View, Text, Button, Box, Image, Heading, Center, Divider, Input, HStack, VStack, Modal } from 'native-base';
...
const Login = ({ route, navigation }) => {
  ...
  //         // Retrieve the status field from the 'users' reference
  ...
  //           navigation.replace('Admin'); // Navigate to the admin page
  //         } else {
  //           navigation.replace('Tabs'); // Navigate to the regular user page
  //         }
  //       })
  //       .catch((error) => {
  //         console.log('Error', error.message);
  //         setFormError(
  //           'Email atau Password salah, Harap masukan Email atau Password dengan benar'
  //         );
  //         toggleModal();
  //       });
  //   } else {
