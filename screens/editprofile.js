...
const EditProfile = ({ navigation }) => {
    ...
    return (
        <>
            ...
            <ScrollView>
                <Box w={"90%"} alignSelf={"center"} borderRadius={10} h={630} mt={5} bg={"white"}>
                    <Box p={12} alignItems="center">
                        <Icon as={Ionicons} name="person-circle-outline" size={200} color="black" />
                        <Heading>EDIT PROFILE</Heading>
                    </Box>
                    <Divider w={"90%"} alignSelf="center" justifyContent="center" bg={"black"} mt={-5} />
                    <VStack>
                        ...
                        <HStack mr={5} ml={5} mt={5} mb={3} justifyContent="space-between">
                            <Text mt={2} bold>Password</Text>
                            <Input borderRadius={15} borderWidth={1} borderColor={"black"} variant="outline" h={10} w={"70%"} placeholder="Masukan Alamat Baru" value={profile.password}
                                onChangeText={(text) => setProfile({ ...profile, password: text })}></Input>
                        </HStack>
